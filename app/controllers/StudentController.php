...
class StudentController extends \BaseController {
	...
	public function __construct(){
		...
		$this->filter_params = array('branch');
	...
	public function index()
	{
		...
		$students = Student::select('student_id', 'first_name', 'last_name', 'roll_num', 'branch')
			->where($conditions)
			->orderBy('student_id');
	...
	public function create()
	{
		...
		$students = Student::select('student_id', 'first_name', 'last_name', 'roll_num', 'branch', 'books_issued')
			->where($conditions)
			->orderBy('student_id');
	...
	public function postRegistration(){
		...
		if($validator->fails()) {
			...
			$student = Student::create(array(
				...
				'student_id'		=> Input::get('rollnumber'),
